...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pytoolconfig-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pytoolconfig-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pytoolconfig
# for installing globally
pixi global install pytoolconfig
```
...
It is possible to list all of the versions of `pytoolconfig` available on your platform:
...
```
pixi search pytoolconfig --channel conda-forge
```
